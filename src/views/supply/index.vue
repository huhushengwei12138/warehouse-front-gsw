<template>
    ...
    <div>
      <el-form inline class="searchForm">
        <el-form-item>
          <el-input v-model="params.supplyName" placeholder="供货商名称" style="width: 120px;"  clearable></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="params.address" placeholder="地址" style="width: 120px;"  clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="supplyPageList" style="width: 100%; margin-top: 10px;" table-layout="auto" size="large" border stripe>
      ...
      <el-table-column label="操作">
        <template #default="props">
          <el-button type="primary" title="修改供应商" :icon="Edit" circle @click="openSupplyUpdate(props.row)" />
          <el-button type="danger" title="删除供应商" :icon="Delete" circle @click="deleteSupply(props.row.supplyId)" />
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
