<template>
    ...
    <div>
      <el-form class="searchForm">
        ...
        <el-form-item label="用户角色:" style="margin-left: 30px;">
          <el-select v-model="params.roleId" placeholder="用户角色" style="width: 120px;" clearable>
    ...
    <el-table :data="userList" ref="multipleTableRef" @selection-change="handleSelectionChange" style="width: 100%; margin-top: 10px;" table-layout="auto" size="large" border stripe>
      ...
      <el-table-column label="操作">
        <template #default="props">
          ...
          <el-button type="primary" v-if="props.row.userState==1" @click="openUpdateAuth(props.row)">查看权限</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
