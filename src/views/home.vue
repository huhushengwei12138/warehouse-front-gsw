<template>
  <el-container class="home-container">
    <el-aside style="width: 217px">
      ...
      >
        <el-sub-menu
          v-for="(firstMenu, idx) of menuList"
          :key="firstMenu.authId"
          :index="idx"
        >
          <template #title>
            ...
            <el-icon v-if="firstMenu.authName == '商品管理'">
              ...
              >
                <path
                  d="M691.2 870.4H307.2c-14.336 0-25.6-11.264-25.6-25.6s11.264-25.6 25.6-25.6h384c14.336 0 25.6 11.264 25.6 25.6s-11.264 25.6-25.6 25.6z"
                  p-id="6227"
                ></path>
                <path
                  d="M874.496 998.4H149.504c-42.496 0-76.8-34.304-76.8-76.8l0.512-7.168 58.368-614.4c3.584-39.936 36.352-69.632 76.288-69.632h608.256c39.936 0 72.704 29.696 76.288 69.632l58.368 614.4c2.048 20.48-4.096 40.448-17.408 56.32-12.8 15.872-31.744 25.6-52.224 27.648h-6.656zM207.872 281.6a25.6 25.6 0 0 0-25.6 23.04l-58.368 614.4c0 16.384 11.264 28.16 25.6 28.16h724.48c9.216-1.024 15.36-4.096 19.968-9.216s6.144-11.776 5.632-18.432l-58.368-614.4a25.2416 25.2416 0 0 0-25.6-23.04H207.872z"
                  p-id="6228"
                ></path>
                <path
                  d="M716.8 384c-14.336 0-25.6-11.264-25.6-25.6V256c0-98.816-80.384-179.2-179.2-179.2S332.8 157.184 332.8 256v102.4c0 14.336-11.264 25.6-25.6 25.6s-25.6-11.264-25.6-25.6V256C281.6 129.024 385.024 25.6 512 25.6s230.4 103.424 230.4 230.4v102.4c0 14.336-11.264 25.6-25.6 25.6z"
                  p-id="6229"
                ></path>
              </svg>
            </el-icon>
            <el-icon v-if="firstMenu.authName == '盘点管理'">
              ...
              >
                <path
                  d="M799.721813 0.000044H113.779a113.64648 113.64648 0 0 0-113.74587 113.74587v685.975943a113.635437 113.635437 0 0 0 113.74587 113.74587h685.942813a113.635437 113.635437 0 0 0 113.74587-113.74587v-684.242147C913.467683 51.70472 863.496803 0.000044 799.721813 0.000044z m48.25917 749.73989a98.185877 98.185877 0 0 1-98.285267 98.285266h-585.95688a98.19692 98.19692 0 0 1-98.285266-98.285266V163.738881a98.19692 98.19692 0 0 1 98.285266-98.285267h586.001054a98.19692 98.19692 0 0 1 98.285266 98.285267z m0 0"
                  p-id="7161"
                ></path>
                <path
                  d="M791.108048 210.275298c0 24.118542-22.406832 43.068825-51.704676 43.068824h-570.496277c-27.608221 0-51.704676-18.961326-51.704676-43.068824v-43.068825c0-24.129585 22.406832-43.068825 51.704676-43.068824h570.496277c27.608221 0 51.704676 18.961326 51.704676 43.068824z m0 0M270.593695 444.669093h-55.150183a34.576536 34.576536 0 0 1-34.466102-34.466103v-55.150182a34.576536 34.576536 0 0 1 34.466102-34.477146h55.150183a34.576536 34.576536 0 0 1 34.466102 34.477146v55.150182a34.576536 34.576536 0 0 1-34.466102 34.466103z m0 0M479.146195 444.669093h-55.150182a34.576536 34.576536 0 0 1-34.477146-34.466103v-55.150182a34.576536 34.576536 0 0 1 34.477146-34.477146h55.150182a34.576536 34.576536 0 0 1 34.477146 34.477146v55.150182a34.576536 34.576536 0 0 1-34.477146 34.466103z m0 0M687.687652 444.669093h-55.139138a34.576536 34.576536 0 0 1-34.477147-34.466103v-55.150182a34.576536 34.576536 0 0 1 34.477147-34.477146h55.139138a34.576536 34.576536 0 0 1 34.477147 34.477146v55.150182a34.576536 34.576536 0 0 1-34.477147 34.466103z m0 0M270.593695 618.744447h-55.150183a34.565493 34.565493 0 0 1-34.466102-34.455059v-55.161226a34.576536 34.576536 0 0 1 34.466102-34.477146h55.150183a34.576536 34.576536 0 0 1 34.466102 34.477146v55.161226a34.565493 34.565493 0 0 1-34.466102 34.455059z m0 0M479.146195 618.744447h-55.150182a34.565493 34.565493 0 0 1-34.477146-34.455059v-55.161226a34.576536 34.576536 0 0 1 34.477146-34.477146h55.150182a34.576536 34.576536 0 0 1 34.477146 34.477146v55.161226a34.565493 34.565493 0 0 1-34.477146 34.466103z m0 0M687.687652 618.744447h-55.139138a34.565493 34.565493 0 0 1-34.477147-34.455059v-55.161226a34.576536 34.576536 0 0 1 34.477147-34.477146h55.139138a34.576536 34.576536 0 0 1 34.477147 34.477146v55.161226a34.565493 34.565493 0 0 1-34.477147 34.466103z m0 0M270.593695 784.172907h-55.150183a34.576536 34.576536 0 0 1-34.466102-34.466103v-55.216442a34.576536 34.576536 0 0 1 34.466102-34.466103h55.150183a34.576536 34.576536 0 0 1 34.466102 34.466103v55.216442a34.576536 34.576536 0 0 1-34.466102 34.466103z m0 0M479.146195 784.172907h-55.150182a34.576536 34.576536 0 0 1-34.477146-34.466103v-55.216442a34.576536 34.576536 0 0 1 34.477146-34.466103h55.150182a34.576536 34.576536 0 0 1 34.477146 34.466103v55.216442a34.576536 34.576536 0 0 1-34.477146 34.466103z m0 0M687.687652 784.172907h-55.139138a34.576536 34.576536 0 0 1-34.477147-34.466103v-55.216442a34.576536 34.576536 0 0 1 34.477147-34.466103h55.139138a34.576536 34.576536 0 0 1 34.477147 34.466103v55.216442a34.576536 34.576536 0 0 1-34.477147 34.466103z m0 0"
                  p-id="7162"
                ></path>
              </svg>
            </el-icon>
            ...
            <el-icon v-if="firstMenu.authName == '入库管理'">
              ...
              >
                <path
                  d="M469.051 81.458c25.147-19.074 59.827-19.239 85.136-0.509l0.764 0.573 391.538 297.91c11.867 9.03 14.168 25.97 5.139 37.837-8.94 11.748-25.632 14.12-37.48 5.406l-0.357-0.268-391.539-297.91a17 17 0 0 0-20.256-0.246l-0.311 0.23-392.814 297.95c-11.88 9.012-28.817 6.686-37.829-5.195-8.921-11.761-6.73-28.478 4.842-37.556l0.353-0.272 392.814-297.95z"
                  p-id="1270"
                ></path>
                <path
                  d="M179 319c14.763 0 26.758 11.848 26.996 26.554L206 346v498.877c0 33.352 26.767 60.453 59.991 60.992l1.009 0.008h207.758c14.911 0 27 12.088 27 27 0 14.762-11.848 26.758-26.554 27H267c-62.878 0-113.97-50.463-114.985-113.099l-0.015-1.901V346c0-14.912 12.088-27 27-27z m666.047 0c14.763 0 26.758 11.848 26.996 26.554l0.004 0.446v190.635c0 14.912-12.088 27-27 27-14.763 0-26.758-11.848-26.996-26.554l-0.004-0.446V346c0-14.912 12.088-27 27-27z"
                  p-id="1271"
                ></path>
                <path
                  d="M697.188 960a36.611 36.611 0 0 0 16.406-3.87 36.638 36.638 0 0 0 20.281-32.773V813.43h183.438c20.258 0 36.687-16.41 36.687-36.643V630.214c0-20.233-16.43-36.642-36.687-36.642H733.875V483.643a36.638 36.638 0 0 0-20.28-32.774 36.725 36.725 0 0 0-38.42 3.46l-293.5 219.857a36.619 36.619 0 0 0 0 58.628l293.5 219.857A36.734 36.734 0 0 0 697.188 960zM908 754.017H730.232c-23.533 0-42.618 18.439-42.618 41.175V900L425 703.788 687.614 513v100.515c0 22.736 19.085 41.175 42.618 41.175H908v99.327z"
                  p-id="1272"
                ></path>
                <path
                  d="M309 613c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z m0-135c11.046 0 20 8.954 20 20v52c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-52c0-11.046 8.954-20 20-20h51z m143 0c11.046 0 20 8.954 20 20v52c0 11.046-8.954 20-20 20h-52c-11.046 0-20-8.954-20-20v-52c0-11.046 8.954-20 20-20h52zM309 339c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z m143 0c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-52c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h52z m142 0c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z"
                  p-id="1273"
                ></path>
              </svg>
            </el-icon>
            <el-icon v-if="firstMenu.authName == '出库管理'">
              ...
              >
                ...
                ></path>
                <path
                  d="M623.813 960a36.611 36.611 0 0 1-16.407-3.87 36.638 36.638 0 0 1-20.281-32.773V813.43H403.687c-20.258 0-36.687-16.41-36.687-36.643V630.214c0-20.233 16.43-36.642 36.687-36.642h183.438V483.643a36.638 36.638 0 0 1 20.28-32.774 36.725 36.725 0 0 1 38.42 3.46l293.5 219.857a36.619 36.619 0 0 1 0 58.628l-293.5 219.857A36.734 36.734 0 0 1 623.812 960zM419 754.017h177.768c23.533 0 42.618 18.439 42.618 41.175V900L902 703.788 639.386 513v100.515c0 22.736-19.085 41.175-42.618 41.175H419v99.327z"
                  p-id="3680"
                ></path>
                <path
                  d="M309 613c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z m0-135c11.046 0 20 8.954 20 20v52c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-52c0-11.046 8.954-20 20-20h51z m143 0c11.046 0 20 8.954 20 20v52c0 11.046-8.954 20-20 20h-52c-11.046 0-20-8.954-20-20v-52c0-11.046 8.954-20 20-20h52zM309 339c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z m143 0c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-52c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h52z m142 0c11.046 0 20 8.954 20 20v51c0 11.046-8.954 20-20 20h-51c-11.046 0-20-8.954-20-20v-51c0-11.046 8.954-20 20-20h51z"
            ...
            <el-icon v-if="firstMenu.authName == '调货管理'">
              ...
              >
                <path
                  d="M731.428571 658.285714a146.285714 146.285714 0 1 0 146.285715 146.285715 146.285714 146.285714 0 0 0-146.285715-146.285715z m0 219.428572a73.142857 73.142857 0 1 1 73.142858-73.142857 73.142857 73.142857 0 0 1-73.142858 73.142857zM256 731.428571A109.714286 109.714286 0 1 0 365.714286 841.142857 109.714286 109.714286 0 0 0 256 731.428571z m36.571429 146.285715H219.428571v-73.142857h73.142858z"
                  p-id="5111"
                ></path>
                <path
                  d="M365.714286 73.142857v73.142857H219.428571L0 438.857143v438.857143h219.428571v-73.142857H73.142857V585.142857h292.571429v219.428572H292.571429v73.142857h365.714285v-73.142857H438.857143V146.285714h512v658.285715h-146.285714v73.142857h219.428571V73.142857z m0 438.857143H73.142857V438.857143l146.285714-219.428572h146.285715z"
                  p-id="5112"
                ></path>
              </svg>
            </el-icon>
            <el-icon v-if="firstMenu.authName == '基础数据'">
              <svg
                t="1646894528224"
                class="icon"
                viewBox="0 0 1024 1024"
    ...
    <el-container class="main-container">
      <el-header>
        <div class="header_left">
          ...
          <span style="font-weight: bold">&nbsp;智能立体仓库管理系统</span>
        </div>
        <div class="header_right">
          <span
            >当前用户：{{
              `${currUser.userCode}【${currUser.userName}】`
            }}</span
          >
      ...
      <el-footer
        >版权所有&nbsp;&copy;2000-2024&nbsp; 万里仓储科技有限公司</el-footer
      >
    </el-container>
  </el-container>
</template>
...
const websocket = new WebSocket("ws://localhost:3333/warehouse/ws/" + clientId);
